...
def gradient = TbtQuadBackgroundComponent.create( 
                                        texture( name:"/Interface/Icons/bordered-gradient.png", 
                                                 generateMips:false ),
                                                 1, 1, 1, 126, 126,
                                                 1f, false );
...
def bevel = TbtQuadBackgroundComponent.create( 
                                        texture( name:"/Interface/Icons/bevel-quad.png", 
                                                 generateMips:false ),
                                                 0.125f, 8, 8, 119, 119,
                                                 1f, false );
...
doubleGradient.texture = texture( name:"/Interface/Icons/double-gradient-128.png", 
                                  generateMips:false )
...
selector( "label", "glass" ) {
    insets = new Insets3f( 5, 20, 5, 20 );
    color = color(0.75, 0.75, 0.75, 0.85)     
}

selector( "container", "glass" ) {
    background = gradient.clone()
    background.setColor(color(0.8, 0.5, 0.5, 0.5))
}
...
selector( "title", "glass" ) {
    ...
    background.texture = texture( name:"/Interface/Icons/double-gradient-128.png", 
                                  generateMips:false )
...
selector( "checkbox", "glass" ) {
    def on = new IconComponent( "/Interface/Icons/Glass-check-on.png", 1f,
                                 0, 0, 1f, false );
    on.setColor(color(0.5, 0.9, 0.9, 0.9))
    on.setMargin(5, 0);
    def off = new IconComponent( "/Interface/Icons/Glass-check-off.png", 1f,
                                 0, 0, 1f, false );
